...
class PipingYOLOv5DetDataPreprocessor(DetDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> dict:
        ...
        gt_levels = data_samples['gt_level']
        img_metas = [{'batch_input_shape': inputs.shape[2:], 'gt_level': gt_levels[i]} for i in range(len(inputs))] 
        data_samples_output = {
