...
class PipingYOLOv5OptimizerConstructor:
    ...
    def __call__(self, model: nn.Module) -> OptimWrapper:
        ...
        for v in model.modules():
            ...
            elif hasattr(v, 'thresholds_a') and isinstance(v.thresholds_a, nn.Parameter):
                params_groups[2].append(v.thresholds_a)
                params_groups[2].append(v.thresholds_b)
