...
# load_from = 'https://download.openmmlab.com/mmyolo/v0/yolov8/yolov8_s_syncbn_fast_8xb16-500e_coco/yolov8_s_syncbn_fast_8xb16-500e_coco_20230117_180101-5aa5f0f1.pth'  # noqa
# load_from = '/root/piping_autodl_bundle/piping_autodl_bundle/mmyolo/weights/best_coco_破裂_precision_epoch_25.pth'
...
deepen_factor = 0.33
# The scaling factor that controls the width of the network structure
# best_coco_破裂_precision_epoch_25.pth 对应 YOLOv8-S 结构，stem=32，因此这里必须使用 widen_factor=0.5。
widen_factor = 0.5
# Strides of multi-scale prior box
strides = [8, 16, 32]
# The output channel of the last stage
